...
describe('GraphVertex', () => {
    it('shold throw an error when trying to create a vertex without a value', () => {
        let vertex = null;
    ...
    it('should add an edge to vertex and check if it exists', () => {
    ...
    it('should return vertex neighbors in case if the current node is start one', () => {
        const vertexA = new GraphVertex('A');
        const vertexB = new GraphVertex('B');
        const vertexC = new GraphVertex('C');
    ...
    it('should return vertex neighbors in case if current node is end one', () => {
        ...
        // we have not told b about any of these edges
        expect(vertexB.getNeighbors()).toEqual([]);
    ...
    it('should check if vertex has a specific neighbor', () => {
        const vertexA = new GraphVertex('A');
        const vertexB = new GraphVertex('B');
        const vertexC = new GraphVertex('C');
