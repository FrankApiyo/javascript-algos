...
describe('LinkedList', () => {
    ...
    it('should be possible to store objects in a the list and print them out', () => {
        const linkedList = new LinkedList();
    ...
    it('should find preffering callback over compare function', () => {
